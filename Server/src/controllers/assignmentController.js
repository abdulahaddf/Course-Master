...
import { assignmentSchema, assignmentReviewSchema } from '../validators/authValidator.js';
...
export const createAssignment = async (req, res, next) => {
  try {
    ...
    if (existingAssignment) {
      return res.status(400).json({ error: 'Assignment already submitted for this module' });
    }
